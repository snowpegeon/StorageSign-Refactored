...
/**
 * Utility methods for {@link Material#OMINOUS_BOTTLE}.
 *
 * <p>Encapsulates sign text and item-lore serialisation for ominous bottles, including
 * their amplifier level (0–4).
 */
public final class OminousBottleHelper {
    ...
    /**
     * Reads the amplifier from an item's meta.
     *
     * @return amplifier level, or 0 if none is set.
     */
