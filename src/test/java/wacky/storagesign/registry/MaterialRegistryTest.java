...
class MaterialRegistryTest {
    ...
    @Test
    void signMaterialsIncludesHangingSigns() {
        // SIGN_MATERIALS catches everything ending with _SIGN (no _WALL_),
        // including HANGING_SIGN variants — so it is larger than WALL_SIGN_MATERIALS.
        assertTrue(MaterialRegistry.SIGN_MATERIALS.size() > MaterialRegistry.WALL_SIGN_MATERIALS.size(),
            "SIGN_MATERIALS should be larger than WALL_SIGN_MATERIALS because it also includes HANGING_SIGN variants");
    }
