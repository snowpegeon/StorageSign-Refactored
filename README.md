...
| 機能 | 説明 | 設定キー |
|---|---|---|
| 自動インポート | 搬送ブロック（ホッパー/ドロッパー/ディスペンサー/クラフター/ホッパー付きトロッコ）がアイテムを押し込むと StorageSign 経由でコンテナへ自動格納 | `auto-import` |
| 自動エクスポート | 搬送ブロック（ホッパー/ドロッパー/ディスペンサー/クラフター/ホッパー付きトロッコ）がアイテムを引き出す・排出すると StorageSign 経由で在庫同期 | `auto-export` |
